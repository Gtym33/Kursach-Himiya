...
NCountry = {
	...
	MIN_MAJOR_COUNTRIES	= 9,						-- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
...
NAI = {
	...
	DEMOCRACIES_ALLY_COMMUNISTS = -25,
	DEMOCRACIES_ANTAGONIZE_FASCISTS = 0,
	DEMOCRACIES_ANTAGONIZE_DEMOCRACIES = -10,
