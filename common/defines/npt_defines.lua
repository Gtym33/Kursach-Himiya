...
NDefines.NAI.ORG_UNIT_WEAK = 0.50
NDefines.NAI.STR_UNIT_STRONG = 0.85
...
NDefines.NAI.MAIN_ENEMY_FRONT_IMPORTANCE = 15.0
NDefines.NAI.AREA_DEFENSE_BASE_IMPORTANCE = 5.0
NDefines.NAI.AREA_DEFENSE_CIVIL_WAR_IMPORTANCE = 5.0
NDefines.NAI.MAX_UNITS_FACTOR_AREA_ORDER = 2.0
NDefines.NAI.DESIRED_UNITS_FACTOR_AREA_ORDER = 2.0
NDefines.NAI.MIN_UNITS_FACTOR_AREA_ORDER = 1.0
NDefines.NAI.VP_GARRISON_VALUE_FACTOR = 1.0
NDefines.NAI.STATE_GARRISON_MAX_UNITS = 6
NDefines.NAI.ORG_UNIT_WEAK = 0.50
NDefines.NAI.ORG_UNIT_NORMAL = 0.65
NDefines.NAI.STR_UNIT_WEAK = 0.45
NDefines.NAI.STR_UNIT_NORMAL = 0.6
NDefines.NAI.STR_UNIT_STRONG = 0.85
NDefines.NMilitary.PLAN_EXECUTE_BALANCED_LIMIT = -5
NDefines.NAI.UNIT_ASSIGNMENT_TERRAIN_IMPORTANCE = 100.0
NDefines.NMilitary.PLAN_SUPPLY_FACTOR = 0.001
NDefines.NAI.DEPLOY_MIN_EQUIPMENT_WAR_FACTOR = 0.75
NDefines.NAI.DEPLOY_MIN_EQUIPMENT_PEACE_FACTOR = 0.50
...
NDefines.NAI.MICRO_POCKET_SIZE = 1
