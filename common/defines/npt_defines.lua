...
NDefines.NMilitary.LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.058
...
NDefines.NMilitary.FASTER_ORG_REGAIN_MULT = 1.00
NDefines.NMilitary.SLOWER_ORG_REGAIN_LEVEL = 0.55
NDefines.NMilitary.SLOWER_ORG_REGAIN_MULT = 0.75
